...
public class ReciprocalArraySumTest extends TestCase {
    ...
    private double parTestHelper(final int N, final boolean useManyTaskVersion, final int ntasks) {
        ...
        System.out.println("Sequential execution time: " + seqTime);
        System.out.println("Execution time with " + getNCores() + " processors: " + parTime);
        System.out.println("SpeedUp = " + (double)seqTime / (double)parTime );
